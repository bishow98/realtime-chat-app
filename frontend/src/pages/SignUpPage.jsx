...
const SignUpPage = () => {
  ...
  const validateFrom = () => {
    ...
    if(formData.password.length < 6) return toast.error("Password must be at least Six characters");
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <AuthImagePattern 
        ...
        subtitle="Connect withfriends, share moments, and stay touch with your loved ones "
      />
    </div>
  );
};
